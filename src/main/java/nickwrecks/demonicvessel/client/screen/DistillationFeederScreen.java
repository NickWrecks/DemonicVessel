...
public class DistillationFeederScreen extends AbstractContainerScreen<DistillationFeederMenu> {
    ...
    private final String info = "Feeds the Famished Generator it is attached to, without feeding it unecessarily. Requires a campfire beneath it, to distill the food for the generator.";
    @Override
    protected void init() {
        super.init();
    ...
    protected void renderBg(PoseStack pPoseStack, float pPartialTick, int pMouseX, int pMouseY) {
        ...
        if(isOverFire)  blit(pPoseStack,leftPos+81,topPos+61,177,1,13,13);
